...
if (isset($_POST['update'])) {
    ...
    if (!empty($_POST['pword'])) {
        ...
        $updateUser   = "UPDATE userstable SET
                            firstname='$firstName',
                            lastname='$lastName',
                            username='$userName',
                            email='$email',
    ...
    $run = mysqli_query($conn, $updateUser);
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    @media (max-width: 480px) {
      body { align-items: flex-start; padding-top: 32px; overflow-y: auto; }
...
<div class="wrapper">
  ...
  <div class="brand">
    ...
    <h1>Edit User</h1>
    <p>Editing record for <strong><?php echo htmlspecialchars($user['firstname'] . ' ' . $user['lastname']); ?></strong></p>
  </div>
  ...
  <div class="card">
    <form method="POST" action="">
      ...
      <div class="field">
        ...
        <div class="input-wrap">
          <input type="password" id="pword" name="pword" placeholder="Leave blank to keep current" />
        ...
        <span class="password-note">⚠ Only fill this in if you want to change the password.</span>
      </div>
